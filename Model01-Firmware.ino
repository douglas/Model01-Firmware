...
#define BUILD_INFORMATION "- douglas v0.1 (kaleidoscope 0.22)"
#endif
...
KEYMAPS(
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   LockLayer(NUMPAD),  Key_6, Key_7, Key_8,     Key_9,         Key_0,    Key_Backspace,     
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___, ___, ___, ___, ___, ___, ___,
   ...
   M(MACRO_VERSION_INFO),  ___, Key_Keypad0, Key_KeypadDot, Key_KeypadMultiply, Key_KeypadDivide,   Key_Enter,
   ___, ___, ___, ___,
   ___),
